...
import { Factory, Context, MergeOptions, Proccessor, Repo, Repos } from  './backup.d.ts'
import { JSONFilePreset } from 'lowdb/node';
import { extend, removeDuplicates } from './utils.ts';
...
let factory: Proccessor[] = [new GitRepoProcessor()];
